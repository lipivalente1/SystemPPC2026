...
function resolveDynamicAnchor(frag, isEmpty) {
	...
	if (closeOwner === 1) {
		...
		else throw new Error(`Failed to locate ${frag.anchorLabel} fragment anchor. this is likely a Vue internal bug.`);
...
function executeAnchorPlan(frag, plan) {
	...
	let exitHydrationBoundary;
	const createRuntimeAnchor = () => frag.anchor = markHydrationAnchor(/* @__PURE__ */ createComment(frag.anchorLabel));
	try {
		switch (plan.kind) {
			case "reuse":
...
var SlotFragment = class extends DynamicFragment {
	constructor(notifyParent = false) {
		super("slot", false, false, false, false);
		this.isSlot = true;
		this.disposed = false;
...
var unmountApp = (app) => {
	unmountComponent(app._instance || rootInstances.get(app), app._container);
...
//#endregion
export { setBlockText as $, isRef as $a, resolveTransitionHooks$1 as $i, createCanSetSetupRefChecker as $n, isRuntimeOnly as $r, unsafeToTrustedHTML as $t, createVaporApp as A, warnExtraneousAttributes as Aa, onUpdated as Ai, MoveType as An, getFunctionalFallthrough as Ar, createApp as At, insert as B, withScopeId as Ba, queueJob as Bi, baseEmit as Bn, hydrateOnVisible as Br, hydrate as Bt, createInvoker as C, useSlots as Ca, onDeactivated as Ci, Comment$1 as Cn, normalizeStyle as Co, ensureValidVNode as Cr, TransitionGroup as Ct, createSlot as D, validateProps as Da, onRenderTriggered as Di, Fragment as Dn, getAttributeMismatch as Dr, baseApplyTranslation as Dt, createSelector as E, validateComponentName as Ea, onRenderTracked as Ei, ErrorTypeStrings as En, flushOnAppMount as Er, VueElementBase as Et, defineVaporSSRCustomElement as F, watchSyncEffect as Fa, popScopeId as Fi, Teleport as Fn, handleError as Fr, ensureRenderer as Ft, on as G, customRef as Ga, renderSlot as Gi, checkTransitionMode as Gn, invokeDirectiveHook as Gr, patchProp as Gt, isVaporComponent as H, ReactiveEffect as Ha, registerHMR as Hi, baseResolveTransitionHooks as Hn, initFeatureFlags as Hr, nodeOps as Ht, delegate as I, withCtx as Ia, popWarningContext as Ii, Text$1 as In, hasInjectionContext as Ir, forceReflow as It, remove as J, getCurrentScope as Ja, resolveDirective as Ji, computed as Jn, isHydrating as Jr, resolveTransitionProps as Jt, onBinding as K, effect as Ka, resetShapeFlag as Ki, cloneVNode as Kn, isAsyncWrapper as Kr, patchStyle as Kt, delegateEvents as L, withDefaults as La, provide as Li, VaporSlot as Ln, hydrateOnIdle as Lr, getValue as Lt, defineVaporAsyncComponent as M, watch as Ma, performAsyncHydrate as Mi, SchedulerJobFlags as Mn, getTransitionRawChildren as Mr, defineCustomElement as Mt, defineVaporComponent as N, watchEffect as Na, performTransitionEnter as Ni, Static as Nn, guardReactiveProps as Nr, defineSSRCustomElement as Nt, createTemplateRefSetter as O, version as Oa, onServerPrefetch as Oi, KeepAlive as On, getComponentName as Or, baseUseCssVars as Ot, defineVaporCustomElement as P, watchPostEffect as Pa, performTransitionLeave as Pi, Suspense as Pn, h as Pr, ensureHydrationRenderer as Pt, setBlockKey as Q, isReadonly as Qa, resolveTarget as Qi, createBlock as Qn, isMismatchAllowed as Qr, svgNS as Qt, getDefaultValue as R, withDirectives as Ra, pushScopeId as Ri, activate as Rn, hydrateOnInteraction as Rr, handleMovedChildren as Rt, createIf as S, useSSRContext as Sa, onBeforeUpdate as Si, BaseTransitionPropsValidators as Sn, normalizeProps as So, endMeasure as Sr, Transition as St, createPlainElement as T, useTransitionState as Ta, onMounted as Ti, ErrorCodes as Tn, toHandlerKey as To, expose as Tr, VueElement as Tt, next as U, TrackOpTypes as Ua, registerRuntimeCompiler as Ui, callWithAsyncErrorHandling as Un, inject as Ur, normalizeContainer as Ut, isFragment as V, EffectScope as Va, queuePostFlushCb as Vi, baseNormalizePropsOptions as Vn, initCustomFormatter as Vr, initDirectivesForSSR as Vt, nthChild as W, TriggerOpTypes as Wa, renderList as Wi, callWithErrorHandling as Wn, invalidateMount as Wr, parseEventName as Wt, setAttr as X, isProxy as Xa, resolveFilter as Xi, createAsyncComponentContext as Xn, isMapEqual as Xr, shouldSetAsProp as Xt, renderEffect as Y, getCurrentWatcher as Ya, resolveDynamicComponent as Yi, createAppAPI as Yn, isKeepAlive as Yr, setVarsOnNode as Yt, setBlockHtml as Z, isReactive as Za, resolvePropValue as Zi, createBaseVNode as Zn, isMemoSame as Zr, shouldSetAsPropForVueCE as Zt, createComponent as _, useAsyncComponentState as _a, normalizeRef as _i, vShowOriginalDisplay as _n, unref as _o, defineOptions as _r, vaporInteropPlugin as _t, VaporKeepAlive as a, setRef as aa, isVNode as ai, vModelCheckboxInit as an, reactive as ao, createRenderer as ar, setElementText as at, createFor as b, useInstanceOption as ba, onBeforeMount as bi, xlinkNS as bn, extend as bo, devtools as br, withVaporKeys as bt, VaporTransitionGroup as c, simpleSetCurrentInstance as ca, leaveCbKey as ci, vModelRadio as cn, shallowReactive as co, createTextVNode as cr, setProp as ct, applyRadioModel as d, startMeasure as da, matches as di, vModelSetSelected as dn, stop as do, deactivate as dr, setTemplateRefBinding as dt, setBlockTracking as ea, isSetEqual as ei, useCssModule as en, isShallow as eo, createCommentVNode as er, setClass as et, applySelectModel as f, toClassSet as fa, mergeDefaults as fi, vModelText as fn, toRaw as fo, defineAsyncComponent as fr, setText as ft, createAssetComponent as g, unregisterHMR as ga, nextUid as gi, vShowHidden as gn, triggerRef as go, defineModel as gr, useVaporCssVars as gt, child as h, transformVNodeArgs as ha, nextTick as hi, vShow as hn, toValue as ho, defineExpose as hr, txt as ht, VaporFragment as i, setIsHydratingEnabled$1 as ia, isTemplateRefKey as ii, vModelCheckbox as in, proxyRefs as io, createPropsRestProxy as ir, setDynamicProps as it, createVaporSSRApp as j, warnPropMismatch as ja, openBlock as ji, NULL_DYNAMIC_COMPONENT as jn, getInheritedScopeIds as jr, createSSRApp as jt, createTextNode as k, warn as ka, onUnmounted as ki, MismatchTypes as kn, getCurrentInstance as kr, callPendingCbs as kt, applyCheckboxModel as l, ssrContextKey as la, logMismatchError as li, vModelSelect as ln, shallowReadonly as lo, createVNode as lr, setStaticTemplateRef as lt, applyVShow as m, toStyleMap as ma, mergeProps as mi, vModelTextUpdate as mn, toRefs as mo, defineEmits as mr, template as mt, DynamicFragment as n, setCurrentRenderingInstance as na, isTeleportDisabled as ni, useHost as nn, onScopeDispose as no, createHydrationRenderer as nr, setDOMProp as nt, VaporTeleport as o, setTransitionHooks as oa, isValidHtmlOrSvgAttribute as oi, vModelCheckboxUpdate as on, readonly as oo, createSlots as or, setHtml as ot, applyTextModel as p, toHandlers as pa, mergeModels as pi, vModelTextInit as pn, toRef as po, defineComponent as pr, setValue as pt, prepend as q, effectScope as qa, resolveComponent as qi, compatUtils as qn, isEmitListener as qr, render as qt, VaporElement as r, setDevtoolsHook as ra, isTemplateNode as ri, useShadowRoot as rn, onWatcherCleanup as ro, createInternalObject as rr, setDynamicEvents as rt, VaporTransition as s, shouldUpdateComponent as sa, knownTemplateRefs as si, vModelDynamic as sn, ref as so, createStaticVNode as sr, setInsertionState as st, compile as t, setCurrentInstance as ta, isTeleportDeferred as ti, useCssVars as tn, markRaw as to, createElementBlock as tr, setClassName as tt, applyDynamicModel as u, ssrUtils as ua, markAsyncBoundary as ui, vModelSelectInit as un, shallowRef as uo, currentInstance as ur, setStyle as ut, createComponentWithFallback as v, useAttrs as va, normalizeVNode as vi, withKeys as vn, camelize as vo, defineProps as vr, withAsyncContext as vt, createKeyedFragment as w, useTemplateRef as wa, onErrorCaptured as wi, DeprecationTypes as wn, toDisplayString as wo, ensureVaporSlotFallback as wr, TransitionPropsValidators as wt, createForSlots as x, useModel as xa, onBeforeUnmount as xi, BaseTransition as xn, normalizeClass as xo, devtoolsComponentAdded as xr, withVaporModifiers as xt, createDynamicComponent as y, useId as ya, onActivated as yi, withModifiers as yn, capitalize as yo, defineSlots as yr, withVaporDirectives as yt, getRestElement as z, withMemo as za, pushWarningContext as zi, assertNumber as zn, hydrateOnMediaQuery as zr, hasCSSTransform as zt };

//# sourceMappingURL=vue.runtime.esm-bundler-knA46Kcp.js.map